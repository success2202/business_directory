    ...
    <div class="col-md-8 col-lg-6 col-xl-5 d-flex align-items-center">
      <div class="w-100 py-5 px-md-5 px-xl-6 position-relative">
        ...
        <form class="form-validate" method="POST" action="userProcessor.php">
          <input type="hidden" name="Reglog" value="log">
           <div class="form-group">
          <input name="username" id="username" type="email" placeholder="Enter email" autocomplete="off" required="" data-msg="Please enter your email" class="form-control">
        </div>
        ...
        <p class="text-center"><small class="text-muted text-center">admin login <a href="login.php">Sign in</a></small></p>
        <p class="text-center"><small class="text-muted text-center">create admin account <a href="register.php">Sign Up</a></small></p>
        <hr class="my-4">
      </form>
</div>
    </div>
