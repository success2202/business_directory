...
<section style=" padding: 20px; border-radius: 50px" class="clearfix bg-dark listingSection pt80 pb80 admin-page">
 ...
 <center style="padding:10px"><h3>Add Business</h3></center> 
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
    <form method="POST" action="business_processor.php?userid=<?php echo urlencode($userid) ;?>" class="listing__form" enctype="multipart/form-data">
         ...
         <div class="col-lg-12 d-flex align-items-center form-group no-divider">
          ...
          <div class="form-footer text-center">
            <button type="submit" name="" class="btn-submit">Next</button>
          </div>
        </form>
      </div>
    </div>
