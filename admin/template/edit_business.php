                ...
                <div class="form-group col-md-12 col-xs-12">
                  <div class="imagUploader text-center">
                    <div class="file-upload">
                      ...
                      <input type="file" name="image" id="fff" class="form-control input-sm mb5" placeholder="<?php echo $res['image'];?>"  value="image">
...
move_uploaded_file($tmploc, $dir);
    ...
    $updateBiz = "UPDATE business SET `name`='$name',`description`='$description', `address`='$address',`phone`='$phone', `city`='$city' WHERE `business_id`=$bus_id ";
